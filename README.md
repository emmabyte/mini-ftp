![logo](https://github.com/emmabyte/mini-ftp/blob/main/assets/logo.png?raw=true)

[![Docker Stars](https://img.shields.io/docker/stars/emmalong3/mini-ftp.svg)](https://hub.docker.com/r/delfer/alpine-ftp-server/) [![Docker Pulls](https://img.shields.io/docker/pulls/emmalong3/mini-ftp.svg)](https://hub.docker.com/r/emmalong3/mini-ftp.svg)  [![Tests](https://github.com/emmabyte/mini-ftp/actions/workflows/test.yaml/badge.svg)](https://github.com/emmabyte/mini-ftp/actions/workflows/test.yaml) [![Automated Builds](https://github.com/emmabyte/mini-ftp/actions/workflows/build-and-release.yaml/badge.svg)](https://github.com/emmabyte/mini-ftp/actions/workflows/build-and-release.yaml)
...
Looking for inspiration or ready-to-use configurations? Check out the [**examples/** directory](https://github.com/emmabyte/mini-ftp/tree/main/examples) for:
